        ...
        <ScrollView style={styles.container}>
          <Card containerStyle={{ backgroundColor: '#303030', borderColor: '#303030' }} >
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <View style={{ alignSelf: 'flex-start', flexDirection: 'row' }}>
                ...
                <Text style={{ fontFamily: 'Lato-Regular', fontSize: 18, marginLeft: 15, color: '#26A69A' }}>Total Times Done</Text>
              </View>
              <View style={{ alignSelf: 'flex-end', flexDirection: 'row' }}>
                <Text style={{ fontFamily: 'Lato-Regular', fontSize: 18, color: '#26A69A' }}>42</Text>
              </View>
            </View>
          </Card>
          <Card containerStyle={{ backgroundColor: '#303030', borderColor: '#303030' }} >
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <View style={{ alignSelf: 'flex-start', flexDirection: 'row' }}>
                <Icon name='check' type='font-awesome' color='#2fcc0c' />
                <Text style={{ fontFamily: 'Lato-Regular', fontSize: 18, marginLeft: 15, color: '#26A69A' }}>Best Streak</Text>
              </View>
              <View style={{ alignSelf: 'flex-end', flexDirection: 'row' }}>
                <Text style={{ fontFamily: 'Lato-Regular', fontSize: 18, color: '#26A69A' }}>42</Text>
              </View>
          ...
          <Card containerStyle={{ backgroundColor: '#303030', borderColor: '#303030' }} >
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <View style={{ alignSelf: 'flex-start', flexDirection: 'row' }}>
                <Icon name='check' type='font-awesome' color='#2fcc0c' />
                <Text style={{ fontFamily: 'Lato-Regular', fontSize: 18, marginLeft: 15, color: '#26A69A' }}>Current Streak</Text>
              </View>
              <View style={{ alignSelf: 'flex-end', flexDirection: 'row' }}>
                <Text style={{ fontFamily: 'Lato-Regular', fontSize: 18, color: '#26A69A' }}>42</Text>
              </View>
          ...
          <View>
            <Text style={{ fontFamily: 'Lato-Regular', fontSize: 18, color: '#26A69A', alignSelf: 'center', marginTop: 10 }}> This Month's Streak</Text>
            <Calendar
